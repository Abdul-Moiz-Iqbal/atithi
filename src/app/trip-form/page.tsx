  ...
  return (
    <div className="font-author">
      ...
      <div className="mt-5 sm:mt-8 mb-10 sm:mb-20 mx-auto ">
        <h1 className="text-center text-[18px] sm:text-[30px] font-medium">WANT TO EXPERIENCE REAL INDIA?</h1>
        <p className="my-3 leading-tight text-center text-[16px] px-8 sm:px-0 sm:text-[20px]">Follow us to receive our latest destination inspiration, as well as our travel<br></br> experience for the year to come.</p>
        <p className="mb-5 text-center text-[16px] sm:text-[20px] font-medium">FOLLOW US ON</p>
        <div className=" mx-auto w-fit flex gap-8">
          <Image src={picscart} className="h-[32px] w-[32px] sm:h-[50px] sm:w-[50px]" alt="Coming Soon Global  version" />
          <Image src={insta} className="h-[32px] w-[32px] sm:h-[50px] sm:w-[50px]" alt="Coming Soon Global  version" />
          <Image src={facebook} className="h-[32px] w-[32px] sm:h-[50px] sm:w-[50px]" alt="Coming Soon Global  version" />
