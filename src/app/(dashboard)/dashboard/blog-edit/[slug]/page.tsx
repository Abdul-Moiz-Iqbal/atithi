...
//   // Fetch the blog content when the component mounts
//   useEffect(() => {
...
//         setTitle(data.title);
//         setContent(data.content); // 'content' will be the HTML stored in the DB
//       } catch (error) {
...
//   return (
//     <div className="max-w-3xl mx-auto mt-8 p-8 bg-white shadow-md rounded-lg">
//       <h1 className="text-4xl font-semibold text-gray-800 mb-6">Edit Blog Post</h1>
  ...
  const handleImageRemove = async() => {
    try {
      await fetch('/api/blog/image/delete-image', {
        ...
        body: JSON.stringify({ public_id: cloudImage.public_id ,blogId:id, modelType:'blog'}), // Extract public ID
      });
