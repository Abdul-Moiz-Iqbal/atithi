  ...
  return (
    <div className="py-10  px-7 md:px-24 flex    ">
      ...
      <div className="lg:w-[50%] flex flex-col justify-center gap-[20px]">
        <h1 className="md:mb-8 uppercase text-[20px] md:text-[35px] tracking-wide text-center font-semibold text-main-blue">
          Your India Travel Expert
        </h1>
        <div className=" text-[18px] sm:text-xl md:px-[90px] tracking-wide text-center ">
        ...
        <div className=" text-[18px] sm:text-xl md:px-[90px] tracking-wide text-center ">From paying for services in India to
          interaction with local people, we empower you to handle the
          complexities of India.</div>
        <div className=" text-[18px] sm:text-xl md:px-[90px] tracking-wide text-center ">Make your trip to India safe and stress-free on
        your own</div>
      </div>
    </div>
  );
