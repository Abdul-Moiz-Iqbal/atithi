...
const PlaningCard: React.FC<PlanCardProps> = ({ title, price, image, }) => {
  ...
  return (
    ...
    <div className="w-full py-10 flex flex-col items-center sm:basis-[20%] " style={{ background: 'linear-gradient(0deg, rgba(233,233,233,0) 0%, rgba(255,241,245,1) 49%, rgba(217,217,217,0) 100%)' }}>
      ...
      <button className="px-[25px] py-[6px] sm:px-[50px] sm:py-[7px] text-xl sm:text-[18px] hover:bg-main-red font-medium rounded-full shadow-btn-shadow border-[3px] border-main-red bg-gradient-to-r from-main-red to-main-orange bg-transparent text-transparent bg-clip-text    ">Select</button>
    </div>
  );
};
