...
const Button: React.FC<ButtonProps> = ({ text, className, onClick }) => {
  return (
    <button
      ...
      className={`${className} px-4 py-3 lg:px-[20.5px] text-[14px] sm:text-[20px] sm:tracking-[0.4px] sm:py-[17px] font-medium bg-main-red text-white uppercase shadow-btn`}
    >
      {text}
    </button>
  );
